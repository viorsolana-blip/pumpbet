...
CREATE INDEX IF NOT EXISTS idx_coins_featured ON coins(is_featured);
CREATE INDEX IF NOT EXISTS idx_coins_upvotes ON coins(upvotes DESC);
...
CREATE INDEX IF NOT EXISTS idx_lp_user ON liquidity_providers(user_id);
